...
const CapturaProcesoReparacionScreen = () => {
  ...
  const [showFechaTerminacionPicker, setShowFechaTerminacionPicker] = useState(false);
  const [showHoraTerminacionPicker, setShowHoraTerminacionPicker] = useState(false);
  ...
  const [showFechaProgramadaPicker, setShowFechaProgramadaPicker] = useState(false);
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.urgencyContainer}>
        <TouchableOpacity
          style={[styles.urgencyButton, urgencia === 'Sí' && styles.selectedButton]}
          onPress={() => setUrgencia('Sí')}
        >
          <Text style={[styles.urgencyButtonText, urgencia === 'Sí' && styles.selectedButtonText]}>Sí</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.urgencyButton, urgencia === 'No' && styles.selectedButton]}
          onPress={() => setUrgencia('No')}
        >
          <Text style={[styles.urgencyButtonText, urgencia === 'No' && styles.selectedButtonText]}>No</Text>
        </TouchableOpacity>
      </View>
      ...
      <Text style={styles.selectedDateText}>
        Hora salida seleccionada: {horaSalida.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
      </Text>
      ...
      <Text style={styles.selectedDateText}>
        Hora arribo seleccionada: {horaArribo.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
      </Text>
      ...
      >
        <Text style={styles.dateButtonText}>Seleccionar Fecha de Terminación</Text>
      </TouchableOpacity>
      ...
      >
        <Text style={styles.dateButtonText}>Seleccionar Hora de Terminación</Text>
      </TouchableOpacity>
      ...
      <Text style={styles.selectedDateText}>
        Hora terminación seleccionada: {horaTerminacion.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
      </Text>
      <View style={styles.divider}></View>
      ...
      {/* Modelo */}
       ...
       {/* Numero de serie o placa */}
         ...
         <Text style={styles.reportTitle}>TRABAJOS EFECTUADOS</Text>
          ...
          <Text style={styles.reportTitle}>CONTROL DE CARGA DE GAS REFRIGERANTE</Text>
          
        <Text style={styles.label}>En caso de aplicar, especifique el gas refrigerante utilizado:</Text>
          <TextInput
            style={styles.input}
          ...
          <Text style={styles.label}>Indique la carga de gas refrigerante (en gramos):</Text>
              <TextInput
                style={styles.input}
                value={cargaGas}
      ...
      <View style={styles.optionsContainer}>
        ...
        <TouchableOpacity
          style={[styles.optionButton, motivoCarga.includes('Fuga') && styles.selectedButton]}
          onPress={() => handlePress('Fuga')}
        >
          <Text style={[styles.optionButtonText, motivoCarga.includes('Fuga') && styles.selectedButtonText]}>
            Fuga
          </Text>
        </TouchableOpacity>

        <TouchableOpacity
          style={[styles.optionButton, motivoCarga.includes('Calibración') && styles.selectedButton]}
          onPress={() => handlePress('Calibración')}
        >
          <Text style={[styles.optionButtonText, motivoCarga.includes('Calibración') && styles.selectedButtonText]}>
            Calibración
          </Text>
        </TouchableOpacity>
...
<View>
      ...
      >
        <Text style={styles.dateButtonText}>Seleccionar Fecha Programada</Text>
      </TouchableOpacity>
      ...
      {fechaProgramada && (
        <Text style={styles.selectedDateText}>
          Fecha programada seleccionada: {fechaProgramada.toLocaleDateString()}
        </Text>
      )}
    </View>
