...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Alert, ActivityIndicator, Image, Modal, Pressable } from 'react-native';
          ...
          <View key={reporte.id} style={styles.reporteContainer}>
            ...
            {reporte.firma && (
              <View style={styles.firmaContainer}>
                ...
                <TouchableOpacity onPress={() => openSignatureModal(reporte.firma)}>
                  <Image source={{ uri: reporte.firma }} style={styles.firmaImage} />
                </TouchableOpacity>
              </View>
            )}
